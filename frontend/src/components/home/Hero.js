    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes["button-container"]}>
                <Button className={classes["button-learn-more"]} variant="contained" style={{fontSize: "1.3rem", width: "45%", height: "4rem"}}>LEARN MORE</Button>
                <Button className={classes["button-sign-up"]} variant="text" href="/signup" style={{backgroundColor: "#FFFFFF", fontSize: "1.3rem", width: "45%", height: "4rem"}}>SIGN UP</Button>
            </div>
            </div>
