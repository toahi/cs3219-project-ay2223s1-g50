...
const Profile = () => {
    ...
    const handleSubmit = async () => {
        ...
        setIsLoading(true);
        setEntered(true);
        const res = await axios.put(URL_UPDATE_PASSWORD_USER_SVC, { username, newPassword }, 
    ...
    return (
        ...
        >
            ...
            <Button onClick={handleOnClick} variant="contained" sx={{textTransform: 'none', fontSize: '1.5rem'}}>Change Password</Button>
            {dialog}
        </Box>
    )
}
